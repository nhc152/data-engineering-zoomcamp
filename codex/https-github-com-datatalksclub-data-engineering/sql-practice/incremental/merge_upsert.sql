-- PostgreSQL upsert version of incremental merge.
-- This is safer than append because order_id is the primary key.
...
select * from incremental.fct_orders_merge order by order_id;
